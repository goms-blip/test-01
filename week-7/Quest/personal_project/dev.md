...
- v1 목표: 재료 57개 × 9개 정보 항목 = 513개 데이터 칸 100% 채움 + 검색 도달 3초 이내
...
목표: "모든 기능 동작 + 재료 57개 데이터 완성 + Vercel 배포 완료"
...
- [ ] 나머지 재료 15개 데이터 + 이미지 완성 (총 57개 × 9항목 = 513칸 100%)
...
체크포인트: 8주차 끝 시점에 production URL에서 외부인이 검색·탐색·상세 보기 전부 가능, 513칸 모두 채워져 있음.
...
- [ ] 성공 기준 검증 — ① 513칸 100% ② 검색 도달 3초 이내 두 가지 모두 yes/no 기록
